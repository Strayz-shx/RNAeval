...
def train_val_ResNet_expert_color_mat_cv(device, NN_model, num_epochs, optimizer, scheduler_for_optimizer, loss_function, model_name, training_data_used, val_data_used):
    ...
    train_val_record = dict({'loss_train': loss_value_train, 
                             ...
                             'mcc_train_record': mcc_train,
                             'mcc_val_record': mcc_val,
                             'precision_train_record': precision_train,
                             'precision_val_record': precision_val,
                             'recall_train_record': recall_train,
                             'recall_val_record': recall_val,
                             'specificity_train_record': specificity_train,
                             'specificity_val_record': specificity_val})
