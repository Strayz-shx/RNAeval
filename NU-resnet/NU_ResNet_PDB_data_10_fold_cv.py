...
import numpy as np
from ResNet_architecture_grayscale_mat import RNAInception
...
# Training data
Original_RNA_Data_train = pd.read_csv('PDB_data_reliable_negative_samples_training_data.csv')
...
# Validation data
Original_RNA_Data_val = pd.read_csv('PDB_data_reliable_negative_samples_validation_data.csv')
...
Original_RNA_Data_utilized = pd.concat([Original_RNA_Data_train, 
                                        Original_RNA_Data_val, 
                                        Original_RNA_Data_test], axis=0, ignore_index=True)
...
k_fold = KFold(n_splits=10, shuffle=True, random_state=51)
...
for index_train_data, index_val_test_data in k_fold.split(Original_RNA_Data_utilized):
    ...
    index_train_val_test_data_1 = [index_train_data, index_val_test_data]
...
for k, index_train_val_test_data in enumerate(k_fold_index_train_val_test_data):
    ...
    # Training data
    train_x_color_mat_np, train_x_nt_localized_info_mat_np, train_y_np, train_x_embedding, train_x_ss = data_prep_RNA_mat_3d_nt_localized_info_mat_PDB_data(Original_RNA_Data = train_data_utilized, padding_length=410.0)
    ...
    # Validation data
    val_x_color_mat_np, val_x_nt_localized_info_mat_np, val_y_np, val_x_embedding, val_x_ss = data_prep_RNA_mat_3d_nt_localized_info_mat_PDB_data(Original_RNA_Data = val_data_utilized, padding_length=410.0)
    ...
    model_name_utilized = 'RNA_3d_mat_Fold_'+str(fold_num)+'_NU_ResNet_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
        '_weightd_'+str(weight_decay_value_utilized)+'_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+\
            str(gamma_value_utilized)+'_PDB_data.pth'
    ...
    train_val_record_obtained, saved_models_metrics_obtained = train_val_ResNet_expert_color_mat(device = device_utilized,
                                                                                                    ...
                                                                                                    val_data_used = val_data_utilized)   #训练模型
    ...
    train_val_record_file_name = 'RNA_3d_mat_Fold_'+str(fold_num)+'_NUResNet_train_val_record_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
        '_weightd_'+str(weight_decay_value_utilized)+'_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+\
            str(gamma_value_utilized)+'PDB_data.csv'
    ...
    saved_models_metrics_file_name = 'RNA_3d_mat_Fold_'+str(fold_num)+'_NUResNet_saved_models_metrics_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
        '_weightd_'+str(weight_decay_value_utilized)+'_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+\
            str(gamma_value_utilized)+'PDB_data.csv'
    ...
    best_val_acc_model_k_fold_cv_metric['model_accuracy_list'].append(saved_models_metrics_obtained['best_val_acc_model']['best_val_acc_model_accuracy'])
    best_val_acc_model_k_fold_cv_metric['model_auc_roc_list'].append(saved_models_metrics_obtained['best_val_acc_model']['best_val_acc_model_auc_roc'])
    best_val_acc_model_k_fold_cv_metric['model_auc_roc_check_list'].append(saved_models_metrics_obtained['best_val_acc_model']['best_val_acc_model_auc_roc_check'])
    best_val_acc_model_k_fold_cv_metric['model_mcc_list'].append(saved_models_metrics_obtained['best_val_acc_model']['best_val_acc_model_mcc'])
    best_val_acc_model_k_fold_cv_metric['model_precision_list'].append(saved_models_metrics_obtained['best_val_acc_model']['best_val_acc_model_precision'])
    best_val_acc_model_k_fold_cv_metric['model_recall_list'].append(saved_models_metrics_obtained['best_val_acc_model']['best_val_acc_model_recall'])
    best_val_acc_model_k_fold_cv_metric['model_specificity_list'].append(saved_models_metrics_obtained['best_val_acc_model']['best_val_acc_model_specificity'])
    
    best_val_loss_model_k_fold_cv_metric['model_accuracy_list'].append(saved_models_metrics_obtained['best_val_loss_model']['best_val_loss_model_accuracy'])
    best_val_loss_model_k_fold_cv_metric['model_auc_roc_list'].append(saved_models_metrics_obtained['best_val_loss_model']['best_val_loss_model_auc_roc'])
    best_val_loss_model_k_fold_cv_metric['model_auc_roc_check_list'].append(saved_models_metrics_obtained['best_val_loss_model']['best_val_loss_model_auc_roc_check'])
    best_val_loss_model_k_fold_cv_metric['model_mcc_list'].append(saved_models_metrics_obtained['best_val_loss_model']['best_val_loss_model_mcc'])
    best_val_loss_model_k_fold_cv_metric['model_precision_list'].append(saved_models_metrics_obtained['best_val_loss_model']['best_val_loss_model_precision'])
    best_val_loss_model_k_fold_cv_metric['model_recall_list'].append(saved_models_metrics_obtained['best_val_loss_model']['best_val_loss_model_recall'])
    best_val_loss_model_k_fold_cv_metric['model_specificity_list'].append(saved_models_metrics_obtained['best_val_loss_model']['best_val_loss_model_specificity'])
    
    model_from_last_epoch_k_fold_cv_metric['model_accuracy_list'].append(saved_models_metrics_obtained['last_epoch_model']['last_epoch_model_accuracy'])
    model_from_last_epoch_k_fold_cv_metric['model_auc_roc_list'].append(saved_models_metrics_obtained['last_epoch_model']['last_epoch_model_auc_roc'])
    model_from_last_epoch_k_fold_cv_metric['model_auc_roc_check_list'].append(saved_models_metrics_obtained['last_epoch_model']['last_epoch_model_auc_roc_check'])
    model_from_last_epoch_k_fold_cv_metric['model_mcc_list'].append(saved_models_metrics_obtained['last_epoch_model']['last_epoch_model_mcc'])
    model_from_last_epoch_k_fold_cv_metric['model_precision_list'].append(saved_models_metrics_obtained['last_epoch_model']['last_epoch_model_precision'])
    model_from_last_epoch_k_fold_cv_metric['model_recall_list'].append(saved_models_metrics_obtained['last_epoch_model']['last_epoch_model_recall'])
    model_from_last_epoch_k_fold_cv_metric['model_specificity_list'].append(saved_models_metrics_obtained['last_epoch_model']['last_epoch_model_specificity'])
...
best_val_acc_model_k_fold_cv_file_name = 'RNA_3d_mat_best_val_acc_model_k_fold_cv_batch_NUResNet_'+str(batch_size_value_utilized)+\
      '_lr_'+str(learning_rate_value_utilized)+'_weightd_'+str(weight_decay_value_utilized)+\
            '_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+str(gamma_value_utilized)+'PDB_data.csv'
...
best_val_loss_model_k_fold_cv_file_name = 'RNA_3d_mat_best_val_loss_model_k_fold_cv_batch_NUResNet_'+str(batch_size_value_utilized)+\
      '_lr_'+str(learning_rate_value_utilized)+'_weightd_'+str(weight_decay_value_utilized)+\
            '_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+str(gamma_value_utilized)+'PDB_data.csv'
...
model_from_last_epoch_k_fold_cv_file_name = 'RNA_3d_mat_model_from_last_epoch_k_fold_cv_batch_NUResNet_'+str(batch_size_value_utilized)+\
      '_lr_'+str(learning_rate_value_utilized)+'_weightd_'+str(weight_decay_value_utilized)+\
            '_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+str(gamma_value_utilized)+'PDB_data.csv'
