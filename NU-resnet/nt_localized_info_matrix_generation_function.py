...
bpseq_path = r"../data/RE-datasetA/TrainSetA/511.bpseq"
seq, edge = parse_bpseq(bpseq_path)
bracket = bpseq_to_dot_bracket(bpseq_path)
nt_localized_info_mat_test = nt_localized_info_mat_generator(seq, bracket)
